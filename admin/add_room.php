...
<h2>Add Room</h2>
    ...
    <div class="controls">
    <input type="text" id="span900" name="room_name" class="room_name"  data-provide="typeahead" style="margin: 0 auto;">
    </div>
    </div>
    ...
    <div class="controls">
    <input type="text" id="span900" name="Description" class="Description"  data-provide="typeahead" style="margin: 0 auto;">
    </div>
    </div>
