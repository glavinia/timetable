...
<h2>Add Department</font></h2>
    ...
    <div class="controls">
    <input type="text" id="span900" name="Person" class="Person"  data-items="4" data-provide="typeahead" style="margin: 0 auto;">
    </div>
    </div>
    ...
    <div class="controls">
    <input type="text" id="span900" name="Title" class="Title"  data-items="4" data-provide="typeahead" style="margin: 0 auto;">
    </div>
    </div>
