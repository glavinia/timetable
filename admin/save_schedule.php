...
$student_2th=$students_rowth['Year'];
...
mysql_query("insert into schedule (semester,year,serie,grupa, department,subject,teacher,room,day,nr,time,time_end)
VALUES('$semester','$year','$serie','$grupa','$department' ,'$subject','$teacher','$room','$day','$nr','$time_start','$time_end')")or die(mysql_error());
